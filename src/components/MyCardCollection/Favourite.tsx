            ...
            <InfiniteScrollComponent
                ...
                children={
                    <GlobalCard
                        ...
                        //             <button className=" text-[15px] w-[190px] h-[48px] py-2 px-6 border-[#DD2590] border-2 bg-transparent text-white text-xl font-bold rounded-[53px] hover:bg-gradient-to-r from-[#DD2590] to-[#7A5AF8]">
                        //                 Use this mod
                        //             </button>
                        //             <button className=" text-[15px] w-[190px] h-[48px] py-2 px-6 border-[#DD2590] border-2 bg-transparent text-white text-xl font-bold rounded-[53px] hover:bg-gradient-to-r from-[#DD2590] to-[#7A5AF8]">
                        //                 View mod page
